...
const Lgpd = () => {
  ...
  return (
    <main className="overflow-hidden relative">
      <SEO
        title="Adequação à LGPD sem Complicação para Empresas | Evomatic"
        description="Transforme a LGPD em vantagem competitiva. Diagnóstico, políticas e apoio de DPO para blindar sua empresa em Jundiaí, Campinas e região metropolitana."
        path="/lgpd"
        schemas={[
          serviceSchema({
      ...
      <section className="relative h-[60vh] flex items-center pt-[72px]">
        <img src={lgpdHero} alt="Adequação e conformidade com a LGPD — Lei Geral de Proteção de Dados para empresas" className="absolute inset-0 w-full h-full object-cover" width={1920} height={1080} loading="lazy" decoding="async" />
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <Reveal direction="up">
            <div className="mb-16 max-w-5xl">
              ...
              <h2 className="text-2xl font-bold font-display text-foreground/90 leading-tight mb-4 md:whitespace-nowrap md:text-5xl">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <Reveal direction="up">
            <div className="mb-16 max-w-3xl">
              ...
              <h2 className="text-3xl md:text-5xl font-bold font-display text-foreground/90 leading-tight mb-4 md:whitespace-nowrap">
