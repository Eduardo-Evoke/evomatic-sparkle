  ...
  return (
    <main className="overflow-hidden relative">
      ...
      <section className="relative min-h-[60vh] flex items-center pt-[72px] z-10">
        <img src={firewallHero} alt="Segurança de rede" className="absolute inset-0 w-full h-full object-contain object-right md:object-cover md:object-[75%_center]" width={1920} height={1080} />
