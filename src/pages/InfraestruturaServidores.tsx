    ...
    <main className="overflow-hidden relative">
      ...
      <section className="py-12 px-6 relative z-10 overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(hsla(0,0%,100%,0.55) 1px, transparent 1px), linear-gradient(90deg, hsla(0,0%,100%,0.55) 1px, transparent 1px)",
        ...
        />
        {/* Linhas diagonais mais marcantes */}
        <div
        ...
        {/* Ruído mais intenso */}
        <div
          className="absolute inset-0 pointer-events-none opacity-[0.11] mix-blend-overlay"
          style={{
