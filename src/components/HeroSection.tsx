          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl leading-[1.15] md:leading-tight mb-6 md:mb-8 text-primary font-bold font-display">
            {"Soluções de TI para estruturar, modernizar e conectar sua empresa".split(" ").map((word, i) => {
              ...
              return (
                <span
                  key={i}
                  className={`inline-block opacity-0 animate-[fade-in_0.8s_ease-out_forwards] ${isHighlight ? "text-transparent bg-clip-text bg-gradient-to-r from-primary via-primary to-accent animate-[fade-in_0.8s_ease-out_forwards,glow-text_2.5s_ease-in-out_forwards]" : ""}`}
                  style={{
